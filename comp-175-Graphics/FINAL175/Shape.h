...
public:
	...
	virtual double Intersect(Point eyePointP, Vector rayV) = 0;
	virtual Vector findIsectNormal(Point eyePoint, Vector ray, double dist, double *texR, double *texG, double *texB, SceneMaterial *currentMaterial) = 0;
