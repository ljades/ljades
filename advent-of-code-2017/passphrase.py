...
class Passphrase(object):
    ...
    def num_valid_passphrases(self, phrases):
        sum_valid = 0
        for phrase in phrases:
            if self.is_valid_passphrase_hard(phrase):
                sum_valid += 1

        return sum_valid

    def is_valid_passphrase(self, phrase):
        words_used = {}
    ...
    def is_valid_passphrase_hard(self, phrase):
        words_used = {}
        words_in_phrase = phrase.split(' ')
        ...
        for word in words_in_phrase:
            ...
            if sorted_word in words_used:
                return False
            else:
                words_used[sorted_word] = 1

        return True


pset_input = """sayndz zfxlkl attjtww cti sokkmty brx fhh suelqbp
...
pp = Passphrase()
print pp.num_valid_passphrases(pset_input)
